...
Citizen.CreateThread(function()
  	exports["caue-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('caue-propattach:attach')
AddEventHandler('caue-propattach:attach', function(pPropItem, pTargetFunction)
...
exports("canPullWeaponHoldingEntity", canPullWeaponHoldingEntity)
