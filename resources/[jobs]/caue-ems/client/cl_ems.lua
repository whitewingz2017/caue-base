        ...
        while listening do
            if IsControlJustReleased(0, 38) then
                ...
                elseif pZone == "pillbox_checkin" then
					...
					local finished = exports["caue-taskbar"]:taskBar(1700, (pAction > 0 and not isTriageEnabled) and "Paging a doctor" or "Checking Credentials")
...
AddEventHandler("caue-polyzone:enter", function(pZoneName, pZoneData)
	if pZoneName == "caue-ems:zone" then
...
AddEventHandler("caue-polyzone:exit", function(pZoneName, pZoneData)
	if pZoneName == "caue-ems:zone" or pZoneName == "pillbox_checkin" then
...
Citizen.CreateThread(function()
	...
	-- Armory, pillbox
	exports["caue-polyzone"]:AddCircleZone("caue-ems:zone", vector3(306.28, -601.58, 43.28), 0.4, {
		useZ=true,
		data = {
            job = "ems",
            action = "armory",
	...
	exports["caue-polyzone"]:AddBoxZone("caue-ems:zone", vector3(300.28, -598.83, 43.28), 3.2, 4.2, {
		heading=340,
		minZ=42.28,
		maxZ=45.68,
		data = {
	...
	exports["caue-polyzone"]:AddBoxZone("caue-ems:zone", vector3(296.16, -598.31, 43.28), 2.4, 1.2, {
		heading=250,
		minZ=42.28,
		maxZ=45.68,
		data = {
	...
	exports["caue-polyzone"]:AddBoxZone("caue-ems:zone", vector3(340.82, -596.46, 43.28), 2.4, 1.2, {
		heading=160,
		minZ=42.28,
		maxZ=45.68,
		data = {
	...
	-- Fire Department
	exports["caue-polyzone"]:AddBoxZone("caue-ems:zone", vector3(-629.79, -122.2, 39.22), 6.2, 4.2, {
		heading=353,
		minZ=38.22,
  		maxZ=41.62,
		data = {
