...
RPC.register("caue-phone:getVehicles", function(src)
...
RPC.register("caue-phone:vehicleCoords", function(src, identifier)
    if vehiclesCoords[identifier] ~= nil then
        return vehiclesCoords[identifier]
    end

    local garage = exports["caue-vehicles"]:selectVehicle(identifier, "garage", "garage")
    local garagePos = exports["caue-vehicles"]:getGarage(garage, "pos")
...
RPC.register("caue-phone:payVehicle", function(src, identifier)
    return exports["caue-vehicles"]:payVehicle(identifier, src)
end)
