...
const load = Vue.createApp({
  setup () {
    return {
      ...
      DownloadTitle: 'Baixando Arquivos do Servidor',
      DownloadDesc: "Aguente firme enquanto começamos a baixar todos os recursos necessários para jogar no OGS Block. \n\nAssim que o download for concluído com sucesso, você será colocado no servidor e essa tela desaparecerá. Por favor, não saia ou desligue o seu PC.",

      SettingsTitle: 'Configurações',
      AudioTrackDesc1: 'Quando desativado, a musica será interrompida.',
