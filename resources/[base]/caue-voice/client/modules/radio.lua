...
function StartTransmission()
    ...
    if not IsTalkingOnRadio then
        ...
        TriggerEvent("caue:voice:transmissionStarted", { radio = true })
...
function LoadRadioModule()
    ...
    exports["caue-keybinds"]:registerKeyMapping("", "Radio", "Push-To-Talk", "+transmitToRadio", "-transmitToRadio", "CAPITAL")
    RegisterCommand("+transmitToRadio", StartTransmission, false)
    RegisterCommand("-transmitToRadio", StopTransmission, false)

    exports["caue-keybinds"]:registerKeyMapping("", "Radio", "Push-To-Talk (Secondary)", "+secondaryTransmitToRadio", "-secondaryTransmitToRadio")
    ...
    exports["caue-keybinds"]:registerKeyMapping("", "Radio", "Volume Up", "+increaseRadioVolume", "-increaseRadioVolume")
    RegisterCommand("+increaseRadioVolume", IncreaseRadioVolume, false)
    RegisterCommand("-increaseRadioVolume", function() end, false)

    exports["caue-keybinds"]:registerKeyMapping("", "Radio", "Volume Down", "+decreaseRadioVolume", "-decreaseRadioVolume")
    RegisterCommand("+decreaseRadioVolume", DecreaseRadioVolume, false)
    RegisterCommand("-decreaseRadioVolume", function() end, false)

    exports["caue-keybinds"]:registerKeyMapping("", "Radio", "On / Off", "+toggleRadioState", "-toggleRadioState")
    ...
    exports["caue-keybinds"]:registerKeyMapping("", "Radio", "Channel Up", "+increaseRadioChannel", "-increaseRadioChannel")
    RegisterCommand("+increaseRadioChannel", increaseRadioChannel, false)
    RegisterCommand("-increaseRadioChannel", function() end, false)

    exports["caue-keybinds"]:registerKeyMapping("", "Radio", "Channel Down", "+decreaseRadioChannel", "-decreaseRadioChannel")
    RegisterCommand("+decreaseRadioChannel", decreaseRadioChannel, false)
    RegisterCommand("-decreaseRadioChannel", function() end, false)

    RegisterNetEvent("caue:voice:radio:connect")
    AddEventHandler("caue:voice:radio:connect", ConnectToRadio)

    RegisterNetEvent("caue:voice:radio:disconnect")
    AddEventHandler("caue:voice:radio:disconnect", DisconnectFromRadio)

    RegisterNetEvent("caue:voice:radio:added")
    AddEventHandler("caue:voice:radio:added", AddRadioSubscriber)

    RegisterNetEvent("caue:voice:radio:removed")
    AddEventHandler("caue:voice:radio:removed", RemoveRadioSubscriber)

    RegisterNetEvent("caue:voice:radio:power")
    AddEventHandler("caue:voice:radio:power", SetRadioPowerState)

    RegisterNetEvent("caue:voice:radio:volume")
    AddEventHandler("caue:voice:radio:volume", SetRadioVolume)
    ...
    TriggerEvent("caue:voice:radio:ready")
