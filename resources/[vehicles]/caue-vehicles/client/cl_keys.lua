...
function HotwireVehicle(cb)
    ...
    exports["caue-flags"]:SetVehicleFlag(currentVehicle, "isHotwiredVehicle", true)
end
...
AddEventHandler("vehicle:giveKey", function()
    ...
    if distance ~= -1 and distance < 5 then
        TriggerServerEvent("caue-vehicles:sendKeys", target, identifier, plate)
    else
...
Citizen.CreateThread( function()
    ...
    exports["caue-keybinds"]:registerKeyMapping("", "Vehicle", "Lock/Unlock Vehicle", "+toggleLock", "-toggleLock", "U")
