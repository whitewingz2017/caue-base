...
RegisterNetEvent("caue-scoreboard:AddPlayer")
AddEventHandler("caue-scoreboard:AddPlayer", function(data)
    Scoreboard.Players[data.src] = data
end)

RegisterNetEvent("caue-scoreboard:RemovePlayer")
AddEventHandler("caue-scoreboard:RemovePlayer", function(data)
    Scoreboard.Players[data.src] = nil
    Scoreboard.Recent[data.src] = data
end)

RegisterNetEvent("caue-scoreboard:RemoveRecent")
AddEventHandler("caue-scoreboard:RemoveRecent", function(src)
    Scoreboard.Recent[src] = nil
end)

RegisterNetEvent("caue-scoreboard:AddAllPlayers")
AddEventHandler("caue-scoreboard:AddAllPlayers", function(data, recentData)
