...
$(".garage-entries").on("click", ".garage-spawn", function (e) {
    e.preventDefault();
    $.post("https://caue-phone/vehspawn", JSON.stringify({ id: $(this).data("id") }));
});

$(".garage-entries").on("click", ".garage-track", function (e) {
    e.preventDefault();
    $.post("https://caue-phone/vehtrack", JSON.stringify({ id: $(this).data("id") }));
});

$(".garage-entries").on("click", ".garage-pay", function (e) {
    e.preventDefault();
    $.post("https://caue-phone/vehiclePay", JSON.stringify({ id: $(this).data("id") }));
});