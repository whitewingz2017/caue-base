...
local function getVehiclesTable(shop)
    local _vehicles = RPC.execute("caue-carshop:getVehicles", shop)
...
RegisterNUICallback("Buy", function(data, cb)
    TriggerServerEvent("caue-carshop:change", exports["caue-base"]:getVar("carshop"), currentVehicle, data.modelcar)
    CloseNui()
end)
