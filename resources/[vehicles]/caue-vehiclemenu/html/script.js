...
$(function () {
    ...
    $('.door').on('click', function() {
        ...
        $.post('https://caue-vehiclemenu/openDoor', JSON.stringify({
                doorIndex: doorIndex
            })
        );
    });
    ...
    $('.seat').on('click', function() {
        ...
        $.post('https://caue-vehiclemenu/switchSeat', JSON.stringify({
                seatIndex: seatIndex
            })
        );
    });
    ...
    $('.window').on('click', function() {
        ...
        $.post('https://caue-vehiclemenu/togglewindow', JSON.stringify({
    ...
    $('.engine').on('click', function() {
        if ($(this).parent().hasClass('disabled')) return;
        $.post('https://caue-vehiclemenu/toggleengine', JSON.stringify({}));
    });
    ...
    document.onkeyup = function (data) {
        if (open) {
            ...
            if ((
                ...
                // Z or Esc
                $.post('https://caue-vehiclemenu/escape', JSON.stringify({}));
            }
        }
    };
});
