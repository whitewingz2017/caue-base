RegisterNetEvent("caue-fx:smoke:grenade", function(pCoords)
    local players = exports["caue-infinity"]:GetNerbyPlayers(pCoords, 100)
...
RegisterNetEvent("caue-fx:chain:blingDiamonds", function(pCoords, pType, pSize, pStrengh, pScale)
    local serverId = source
    local players = exports["caue-infinity"]:GetNerbyPlayers(pCoords, 25)
    local ptDict, ptName = "", ""
...
RegisterNetEvent("fx:poo:start", function(PooingID)
    ...
    local players = exports["caue-infinity"]:GetNerbyPlayers(coords, 25)
