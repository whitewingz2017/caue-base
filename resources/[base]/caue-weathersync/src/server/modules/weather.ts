...
setInterval(() => {
    ...
    emitNet("caue-weathersync:client:weather", -1, currentWeather)
    emitNet("caue-weathersync:currentWeather", -1, currentWeather.weather)
}, timePerWeather * 1000)

onNet("caue-weathersync:client:weather:request", () => {
    emitNet("caue-weathersync:client:weather", global.source, weatherProgression[0])
    emitNet("caue-weathersync:currentWeather", global.source, weatherProgression[0].weather)
})

onNet("caue-weathersync:setWeather", (source: string, param: string) => {
    ...
    emitNet("caue-weathersync:client:weather", -1, weatherProgression[0])
    emitNet("caue-weathersync:currentWeather", -1, weatherProgression[0].weather)
})
