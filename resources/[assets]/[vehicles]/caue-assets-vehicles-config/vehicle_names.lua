...
Citizen.CreateThread(function()
	...
	AddTextEntryByHash(GetHashKey("npolchal"), "Dodge Charger Pursuit Police")
	AddTextEntryByHash(GetHashKey("npolstang"), "Ford Mustang Police Interceptor")
	AddTextEntryByHash(GetHashKey("npolchal"), "Chevrolet Corvette Pursuit Police")
	AddTextEntryByHash(GetHashKey("polas350"), "AS350 Police")

	AddTextEntryByHash(GetHashKey("ucballer"), "Baller Undercover")
	AddTextEntryByHash(GetHashKey("ucbanshee"), "Banshee Undercover")
	AddTextEntryByHash(GetHashKey("ucbuffalo"), "Buffalo Undercover")
	AddTextEntryByHash(GetHashKey("uccomet"), "Comet Undercover")
	AddTextEntryByHash(GetHashKey("uccoquette"), "Coquette Undercover")
	AddTextEntryByHash(GetHashKey("ucprimo"), "Primo Undercover")
	AddTextEntryByHash(GetHashKey("ucrancher"), "Rancher Undercover")
	AddTextEntryByHash(GetHashKey("ucwashington"), "Washington Undercover")
