...
AddEventHandler("caue-vehicles:updateVehicleHealth", function(identifier, plate, body, engine)
    local src = source
...
AddEventHandler("caue-vehicles:updateVehicleDegradation", function(identifier, plate, degradations)
    local src = source
...
AddEventHandler("caue-vehicles:adminRepair", function(target)
    ...
    TriggerEvent("caue-vehicles:updateVehicleHealth", vid, plate, 1000, 1000)
    TriggerEvent("caue-vehicles:updateVehicleDegradation", vid, plate, defaultDegradation)
end)
...
AddEventHandler("caue-vehicles:updateVehicleMileage", function(identifier, plate, mileage)
    local src = source
...
RPC.register("caue-vehicles:getDegradation", function(src, identifier, plate)
    return getDegradation(identifier, plate)
end)

RPC.register("caue-vehicles:getMileage", function(src, identifier, plate)
