...
function canRent()
    ...
    if isComplete and dist <= 3.0 then
        ...
        local canRent = RPC.execute("caue-housing:canRent", propertyId)
...
AddEventHandler("caue-housing:handler", function(data, cb)
...
Citizen.CreateThread(function()
    exports["caue-keybinds"]:registerKeyMapping("","Housing", "Interact", "+propertyInteract", "-propertyInteract", "E")
