...
local currentLocation = vector4(0.0, 0.0, -100.0, 0.0)
...
RegisterNetEvent("caue-pawnshop:sell")
AddEventHandler("caue-pawnshop:sell", function()
    local src = source
    ...
    if value == 0 then
        ...
        exports["caue-financials"]:updateCash(src, "+", value)
    end
end)