...
function canUseCustomSkins(skin)
    local hex = RPC.execute("caue-clothes:getHex")

    if whitelisted_to_use_custom_skins[hex] then
        for i, v in ipairs(whitelisted_to_use_custom_skins[hex]) do
            if v == skin then
                return true
            end
        end
