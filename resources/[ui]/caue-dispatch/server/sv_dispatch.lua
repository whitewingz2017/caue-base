...
function addUnit(player, callid)
    ...
    local name = exports["caue-base"]:getChar(player, "first_name") .. " " .. exports["caue-base"]:getChar(player, "last_name")
    local job = exports["caue-base"]:getChar(player, "job")
    local jobName = exports["caue-jobs"]:getJob(job, "name")
    local callsign = exports["caue-jobs"]:getCallsign(player, job)
