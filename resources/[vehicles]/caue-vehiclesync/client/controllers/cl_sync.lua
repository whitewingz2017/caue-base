...
function SetEngineSound(pVehicle)
    local sound = exports["caue-vehicles"]:GetVehicleAfterMarket(pVehicle, "engineSound")
...
function RequestSyncStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent("caue-vehicleSync:updateSyncState", netId, syncState)
    end)
end
...
RegisterNetEvent("caue-vehicles:spawnedVehicleSync")
AddEventHandler("caue-vehicles:spawnedVehicleSync", function(pNetId, pModel)
    Citizen.Wait(1000)
    ...
    local afterMarkets = exports["caue-vehicles"]:GetVehicleAfterMarket(vehicle)
...
Citizen.CreateThread(function()
    exports["caue-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Neon Lights", "+toggleNeonLights", "-toggleNeonLights")
    exports["caue-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Right)", "+toggleRightIndicator", "-toggleRightIndicator")
    exports["caue-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Left)", "+toggleLeftIndicator", "-toggleLeftIndicator")
    exports["caue-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Hazard)", "+toggleHazardLights", "-toggleHazardLights")
end)