...
RegisterServerEvent("caue-inventory:ammo")
onNet("caue-inventory:ammo", async (originInventory, targetInventory, originSlot, targetSlot, originItemId, targetItemId, originItemInfo, targetItemInfo) => {
    let src = source
    let player = exports["caue-base"].getChar(src, "id")
