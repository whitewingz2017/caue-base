...
AddEventHandler("caue-admin:currentDebug",function(toggle)
	dickheaddebug = toggle
end)
    ...
    while true do
        ...
        if dickheaddebug then
            ...
            if IsControlJustReleased(0, 38) then
                if inFreeze then
                    inFreeze = false
                    TriggerEvent("DoLongHudText","Freeze Disabled",3)
                else
                    inFreeze = true
                    TriggerEvent("DoLongHudText","Freeze Enabled",3)
                end
            end
            ...
            if IsControlJustReleased(0, 47) then
                if lowGrav then
                    lowGrav = false
                    TriggerEvent("DoLongHudText","Low Grav Disabled",3)
                else
                    lowGrav = true
                    TriggerEvent("DoLongHudText","Low Grav Enabled",3)
                end
            end
