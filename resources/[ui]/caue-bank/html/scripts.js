...
$("#accounts").on("click", ".accounts-box", function (e) {
    ...
    let id = $(this).data("id");
    $.post("https://caue-bank/transactions", JSON.stringify({
        id: id,
    }));
});
...
$(".w-okay").click(function (e) {
    ...
    if (wvalue != "" && wvalue > 0) {
        $.post("https://caue-bank/withdraw", JSON.stringify({
            id: id,
            value: wvalue,
            comment: wcomment
        }));
...
$(".d-okay").click(function (e) {
    ...
    if (dvalue != "" && dvalue > 0) {
        $.post("https://caue-bank/deposit", JSON.stringify({
            id: id,
            value: dvalue,
            comment: dcomment
        }));
...
$(".t-okay").click(function (e) {
    ...
    if (tvalue != "" && tvalue > 0 && tid != "" && tid > 0) {
        $.post("https://caue-bank/transfer", JSON.stringify({
            id: id,
            value: tvalue,
            comment: tcomment,
            to: tid
