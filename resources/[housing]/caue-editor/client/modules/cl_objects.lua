...
RegisterNetEvent("caue-editor:buildName")
AddEventHandler("caue-editor:buildName", function(name, objects)
    if objects then
...
AddEventHandler("caue-editor:destroyName", function(name)
    cleanUpArea(name)
