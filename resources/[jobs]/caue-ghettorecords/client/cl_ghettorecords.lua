...
RegisterNetEvent("caue-ghettorecords:activateLasers")
AddEventHandler("caue-ghettorecords:activateLasers", function(doActivate)
...
Citizen.CreateThread(function()
    ...
    exports["caue-polyzone"]:AddPolyZone("ghettorecords_laser", {
    ...
    exports["caue-polytarget"]:AddBoxZone("ghettorecords_music_maker", vector3(-818.17, -719.02, 32.34), 3.0, 0.6, {
        heading = 0,
        minZ = 32.14,
        maxZ = 32.74,
        data = {
    ...
    exports["caue-eye"]:AddPeekEntryByPolyTarget("ghettorecords_music_maker", {{
        event = "caue-music:addMusicEntry",
    ...
    exports["caue-eye"]:AddPeekEntryByPolyTarget("ghettorecords_music_maker", {{
        event = "caue-music:createMusicTapes",
