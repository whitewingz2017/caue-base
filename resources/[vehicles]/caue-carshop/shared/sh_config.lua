...
Config["pdm"] = {
    ...
    Init = function()
        exports["caue-polyzone"]:AddBoxZone("pdm", vector3(-58.34, -1111.57, 26.44), 87.6, 86.8, {
            -- debugPoly = true,
            heading = 339,
            minZ = 23.84,
            maxZ = 37.64,
        ...
        exports["caue-polyzone"]:AddBoxZone("pdmcatalog", vector3(-57.11, -1097.17, 26.42), 1.0, 3.8, {
            -- debugPoly = true,
            heading = 30,
            minZ = 25.42,
            maxZ = 28.02,
        ...
        exports["caue-polyzone"]:AddBoxZone("pdmbackdoor", vector3(-29.28, -1086.63, 26.57), 2.2, 5.0, {
            -- debugPoly = true,
            heading = 340,
            minZ = 25.52,
            maxZ = 28.12,
            ...
            Citizen.CreateThread(function()
                while listening do
                    if IsControlJustReleased(0, 38) then
                        TriggerServerEvent("caue-carshop:pdmBackDoor")
                    end
                    Wait(0)
                end
            end)
        ...
        AddEventHandler("caue-carshop:pdmBackDoor", function(toggle)
            local Simeon = exports["caue-assets-ipls"]:GetSimeonObject()
