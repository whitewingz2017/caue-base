...
RegisterNetEvent("caue-healthcare:yoga")
AddEventHandler("caue-healthcare:yoga", function(pArgs, pEntity, pContext)
...
RegisterNetEvent("caue-healthcare:exercise")
AddEventHandler("caue-healthcare:exercise", function(pArgs, pEntity, pContext)
