	...
	["v_int_49"] = {
		...
		["interact"] = {
			[1] = {
				...
				["useDist"] = 2.0,
				["generalUse"] = {"",""},
				["housingMain"] = {"to swap char or ~g~/outfits~s~.","raid_clothes:outfits"},
				["housingSecondary"] = {"to select char","apartments:Logout"},
			},
			[2] = {
	...
	["np_apartments_room"] = {
		...
		["interact"] = {
			[1] = {
				...
				["housingSecondary"] = {"to leave de character","apartments:Logout"},
			},
			[2] = {
	...
	["v_int_16_high"] = {
		...
		["interact"] = {
			[1] = {
				...
				["useDist"] = 2.0,
				["generalUse"] = {"",""},
				["housingMain"] = {"to open drawer","raid_clothes:outfits"},
				["housingSecondary"] = {"to select char","apartments:Logout"},
			},
			[2] = {
	...
	["v_int_72_l"] = {
		...
		["interact"] = {
			[1] = {
				...
				["useDist"] = 2.0,
				["generalUse"] = {"",""},
				["housingMain"] = {"to enter room","apartments:garageToHouse"},
				["housingSecondary"] = {"to garage.","apartments:garageToWorld"},
			},
		}
	},
